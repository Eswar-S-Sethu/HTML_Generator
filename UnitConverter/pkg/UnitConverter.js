 ...
 * @returns {string}
 */
export function convert_columns(data_json, from_unit, to_unit, whole_num, roundoff) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.convert_columns(ptr0, len0, ptr1, len1, ptr2, len2, whole_num, roundoff);
        deferred4_0 = ret[0];
        deferred4_1 = ret[1];
